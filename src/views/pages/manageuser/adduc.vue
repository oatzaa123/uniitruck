<template>
  <div id="userinfoEditForm">
    <vx-card title="ข้อมูลส่วนตัว UC (Unii Center)">
      <!-- Content Row -->
      <div class="vx-row">
...
export default {
  ...
  methods: {
    ...
    async createcodeRef() {
      let maxId = 1;
      let newId = 0;
      this.newPostKey = await userRef.child("UniiTruck_UC_REF").push().key;
      await userRef
        .child("UniiTruck_UC_REF")
      ...
      await codeRef.child("UniiTruck_UC_REF").once("value", snapshot => {
