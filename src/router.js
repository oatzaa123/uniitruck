  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          path: "/pages/addc",
          name: "page-addc",
          component: () => import("@/views/pages/manageuser/addc.vue"),
          meta: {
            breadcrumb: [
              { title: "Home", url: "/" },
              { title: "Pages" },
              { title: "addc", active: true }
            ],
            pageTitle: "เพิ่ม C",
            rule: "admin"
          }
        },
        {
          path: "/pages/adduc",
          name: "page-adduc",
          component: () => import("@/views/pages/manageuser/adduc.vue"),
          meta: {
            breadcrumb: [
              { title: "Home", url: "/" },
              { title: "Pages" },
              { title: "adduc", active: true }
            ],
            pageTitle: "เพิ่ม UC",
            rule: "admin"
          }
        ...
        {
          path: "/pages/userinfo_ut",
          name: "page-userinfo_ut",
          component: () => import("@/views/pages/userinfo/userinfo_ut.vue"),
          meta: {
            breadcrumb: [
              { title: "Home", url: "/" },
              { title: "Pages" },
              { title: "userinfo_ut", active: true }
            ],
            pageTitle: "จัดการข้อมูลผู้ใช้",
            rule: "admin"
          }
        },
        {
          ...
          name: "page-userinfoEdit",
          component: () => import("@/views/pages/userinfo/userinfoEdit.vue"),
          meta: {
            breadcrumb: [
              { title: "Home", url: "/" },
              { title: "Pages" },
              { title: "userinfoEdit", active: true }
            ],
